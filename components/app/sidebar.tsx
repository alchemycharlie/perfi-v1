 ...
 * Phase 2 Section 2 — Primary navigation (sidebar):
 *   Dashboard, Accounts, Transactions, Budgets, Bills & Subscriptions,
 *   Cashflow, Goals, Debt, Income, Analytics [Pro badge if locked]
 */
...
export function AppSidebar() {
  ...
  return (
    <aside className="hidden w-60 shrink-0 border-r border-border bg-bg-secondary lg:flex lg:flex-col">
      <div className="p-4">
        <Link href="/app/dashboard" className="text-lg font-bold tracking-tight text-text-primary">
          PerFi
        </Link>
      </div>
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M21 12a2.25 2.25 0 00-2.25-2.25H15a3 3 0 110-6h5.25A2.25 2.25 0 0121 6v6zm-3 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm-3 0H3.75A2.25 2.25 0 011.5 9.75v-3.5A2.25 2.25 0 013.75 4h12.5A2.25 2.25 0 0118.5 6.25v3.5A2.25 2.25 0 0116.25 12z"
      />
    </svg>
  );
}
